...
insert into Datatype (datatypeid, name, description, uri, multiple, namespaceid) values (2, 'Publication', 'PMID (PubMed Identifier) is a unique numerical identifier assigned to an article in PubMed. DOI (Digital Object Identifier) is an alphanumeric string assigned to online content, such as articles, book chapters, or data sets. Some examples: 10.3390/cimb45110575 or doi:10.3390/cimb45110575 or https://doi.org/10.3390/cimb45110575', 'https://www.glygen.org/datatype/2', TRUE, 5) ON CONFLICT DO NOTHING;
