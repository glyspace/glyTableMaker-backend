...
insert into Datatype (datatypeid, name, description, uri, multiple, namespaceid) values (7, 'Disease', 'The Disease Ontology ID (DOID) is a unique identifier for human diseases, providing standardized descriptions for the biomedical community. You can search for common disease names and select the corresponding DOID. For example, the DOID for Alzheimer’s disease is DOID:10652.', 'https://www.glygen.org/datatype/7', TRUE, 8) ON CONFLICT DO NOTHING;
